    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white px-4">
        <div className="w-full max-w-md bg-white rounded-xl shadow p-8 flex flex-col items-center">
          ...
          <Button
            className="w-full bg-[#3C5979] hover:bg-[#2f4560]"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white px-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow p-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1 mt-2 mb-4">
            <div className="flex items-center gap-2 text-sm text-gray-700">
              <CheckCircle2 className="w-5 h-5 text-[#3C5979]" />
        ...
        <button
          type="button"
          className="flex items-center text-sm text-gray-700 hover:underline mt-6"
